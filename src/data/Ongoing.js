...
export const Ongoing = [
  {
    name: "Cross Campus",
    summary:
      "Go to the University of California and meet the lovely and dateable mascots across the UC's, take and skip classes to spend time with them, and confess and go to college.",
    image: cross,
  },
  {
    name: "There Is No Other Side",
    summary: "Psychological Horror Game with an inconsistent narrator.",
    image: other,
  },
  {
    name: "Ragdoll",
    summary: "A little cat in a weird world.",
    image: ragdoll,
  },
  {
    name: "Lickety Split",
